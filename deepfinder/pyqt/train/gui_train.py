...
sys.path.append('../')
from deepfinder.pyqt.custom_theme import set_custom_theme
...
from  deepfinder.pyqt.train.plot_window import TrainMetricsPlotWindow

qtcreator_file  = 'deepfinder/pyqt/train/gui_train.ui'
