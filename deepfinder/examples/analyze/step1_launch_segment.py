...
# Input parameters:
path_tomo    = 'deepfinder/examples/analyze/in/tomo9.mrc' # tomogram to be segmented
path_weights = 'deepfinder/examples/analyze/in/net_weights_FINAL.h5' # weights for neural network (obtained from training)
