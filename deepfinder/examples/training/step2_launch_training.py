...
path_objl_train = 'deepfinder/examples/training/in/object_list_train.xml'
path_objl_valid = 'deepfinder/examples/training/in/object_list_valid.xml'

Nclass = 13
dim_in = 26 # patch size

# Initialize training task:
trainer = Train(Ncl=Nclass, dim_in=dim_in)
trainer.path_out         = 'deepfinder/examples/training/out/' # output path
